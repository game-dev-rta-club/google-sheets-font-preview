...
3. If setup tells you the Apps Script API is disabled, open [Apps Script user settings](https://script.google.com/home/usersettings)
4. Enable `Google Apps Script API`
5. If you just enabled it, wait a few minutes
6. `npm run push-clasp`
7. Spreadsheet を再読込する
