...
You can find the `scriptId` in the Apps Script editor URL.

```text
https://script.google.com/home/projects/<scriptId>/edit
```

If you run `npm run setup-clasp` without arguments, the setup script will ask for the `scriptId` interactively and explain where to find it.
