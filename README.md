...
1. `npm install`
2. `npm run setup-clasp -- <Apps Script URL or scriptId>`
3. `npm run login-clasp`
4. Open [Apps Script user settings](https://script.google.com/home/usersettings)
5. Enable `Google Apps Script API`
...
If you run `npm run setup-clasp` without arguments, the setup script will ask for the Apps Script URL or `scriptId` interactively and explain where to find it.
